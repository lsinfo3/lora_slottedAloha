    ...
    for x in payload_bytes:
        for y in SF:
            for z in guard_time:
                ...
                run_sim_parallelized(number_of_sensors,y,x,payload_size_to_time(x,y),payload_size_to_time(x,y)*(z/100),gw_duty_cycle,max_acceptable_time_drift)
...
if __name__ == '__main__':
    ...
    run_sim_sweep(number_of_sensors,[7,8,9,10,11,12],[8],8,[10],gw_duty_cycle,max_acceptable_time_drift)
